...
#'
#' - `makeCacheMatrix` creates the necessary structure, and
#' - `cacheSolve` does the actual computation and caching
#' 
...
#'
#' - first time it will calculate the inverse, cache the result, and return the cached value
